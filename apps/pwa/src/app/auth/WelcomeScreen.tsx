...
export function WelcomeScreen() {
  ...
  return (
    <div className="app-frame mx-auto flex max-w-lg flex-col overflow-y-auto bg-brand px-6 pt-[calc(env(safe-area-inset-top)+2rem)] pb-[calc(env(safe-area-inset-bottom)+2rem)] text-white">
